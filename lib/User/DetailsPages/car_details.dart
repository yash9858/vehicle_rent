  ...
  Future<void> fetchFeedbacks() async {
    try {
      var feedbackSnapshot = await FirebaseFirestore.instance
          ...
          .where('Vehicle_Id', isEqualTo: carId)
          .get();
...
class _CarDetailsState extends State<CarDetails> {
  late final CarDetailController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.put(CarDetailController(widget.carId));
  }
